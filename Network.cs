...
public class Network<T>
{
    ...
    /// <summary>
    ///     The user-provided assumptions about the network.
    /// </summary>
    private readonly Zen<bool>[] assumptions;
    ...
    public Network(
        ...
        Dictionary<string, Func<Zen<T>, Zen<bool>>> monolithicProperties, Zen<bool>[] assumptions)
    {
