...
{
  private static AnnotatedNetwork<CSetRoute, Unit> CSetNet(
    ...
    Dictionary<string, Func<Zen<CSetRoute>, Zen<BigInteger>, Zen<bool>>> annotations)
  {
    ...
    return new AnnotatedNetwork<CSetRoute, Unit>(topology, topology.MapEdges(transfer), Merge, initial,
      annotations,
      modularProperties, monolithicProperties, Array.Empty<SymbolicValue<Unit>>());
  }

  private static AnnotatedNetwork<SetRoute, Unit> SetNet(
    ...
    Dictionary<string, Func<Zen<SetRoute>, Zen<BigInteger>, Zen<bool>>> annotations)
  {
    ...
    return new AnnotatedNetwork<SetRoute, Unit>(topology, topology.MapEdges(SetTransfer), Merge, initial,
      annotations,
      modularProperties, monolithicProperties, Array.Empty<SymbolicValue<Unit>>());
  }
