...
python3 ./run_all.py -n 1 -t 7200 -k 4 40 -- lw -m
python3 ./run_all.py -n 1 -t 7200 -k 4 40 -- v -m
python3 ./run_all.py -n 1 -t 7200 -k 4 40 -- h -m
# all pairs versions
...
python3 ./run_all.py -n 1 -t 7200 -k 4 40 -- ar -m
