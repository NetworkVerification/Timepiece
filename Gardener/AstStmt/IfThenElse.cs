...
{
  [JsonRequired] public Expr<bool, TState> Guard { get; }
  [JsonRequired] public Statement<T, TState> TrueStatement { get; }
  [JsonRequired] public Statement<T, TState> FalseStatement { get; }
